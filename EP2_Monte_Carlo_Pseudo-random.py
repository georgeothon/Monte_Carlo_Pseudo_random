...
def Hit_or_miss(n=200):
    ...
    while erro >= 0.01:
        ...
        for i in range(1,n+1):
            ...
            h = 0
            for k in range(i):
                h += f(random.random()) > random.random()
...
def Importance_Sampling(n=100):
    ...
    while erro >= 0.01:
        ...
        for i in range(1,n+1):
            ...
            #Gerador de pseudo-aleatório com distribuição beta
            p = np.random.beta(0.9,1,100)
            x = beta.pdf(p,0.9,1)
...
def main():
    ...
    #Roda cada método 100 vezes e salva o resultado em uma lista
    for i in range(10**2):
        CRUD.append(Crud())
    ...
    print('\n\n Rodando cada métodos 100 vezes \n')
    print('===================================================')
